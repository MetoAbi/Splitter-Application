...
== Projekt aus dem Programmierpraktikum 2023 an der HHU
Entwicklung einer Webanwendung nach dem Onion-Architekturmuster, in Java, Spring Boot, PostgreSQL und REST-API.
